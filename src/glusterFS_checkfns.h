 ...
 *   Modify the glusterFS_checkfns_local.[ch] files insead.
 *   (so that you can regenerate this one as mib2c improvements are made)
 ***********************************************************************/
#ifndef GLUSTERFS_CHECKFNS_H
#define GLUSTERFS_CHECKFNS_H

/** make sure we load the functions that you can modify */
config_require(glusterFS_checkfns_local)
    ...
    /*
     * these functions are designed to check incoming values for 
     * columns in the volumeTable table for legality with respect to 
     * datatype and value.
     */
#endif                          /* GLUSTERFS_CHECKFNS_H */
